...
![Imagen 1](/Imagenes/vista%20general.png)
...
![Listado de usuarios](/Imagenes/Listado%20de%20usuarios.png)

### Filtrar por rol (`?role=admin`)

![Filtrado por rol](/Imagenes/Filtrado%20por%20rol.png)
### Filtrar por estado activo (`?is_active=true`)

![Filtrado por estado activo](/Imagenes/Filtrado%20por%20Activo.png)
...
`[Captura: GET /users/999 — código 404 "Usuario no encontrado"]`
...
![Registro exisotoso](/Imagenes/Registro%20exitoso.png)
...
![Correo existente](/Imagenes/Correo%20existente.png)
...
![Rol inexistente](/Imagenes/Rol%20inexistente.png)
...
![Nombre corto](/Imagenes/Nombre%20corto.png)

### Correo con formato inválido (422)

![Correo invalido](/Imagenes/Correo%20invalido.png)
